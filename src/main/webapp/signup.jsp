...
<%--        //Validate login page before accessing home.jsp page--%>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form form _lpchecked="1" action="Signup" method="post">
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="email" id="emai" class="form-control form-control-lg" name="email" />
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button class="btn btn-dark btn-lg btn-block" type="submit" value="signup">Signup</button>
                                    </div>
                                    <%
                                    ...
                                    <%}%>
                                    <p class="mb-5 pb-lg-2" style="color: #393f81;"> <a href="ulogin.jsp" style="color: #393f81;">Sign in</a></p>
